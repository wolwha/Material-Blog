  ...
  return (
    <>
      <div className="flex flex-col w-full justify-start items-start">
        <div className="flex relative text-start px-[20px] w-full">
        ...
        <div className="sm:grid sm:gap-x-[15px] gap-y-[20px] my-[30px] sm:h-auto 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 select-none w-full px-[16px] flex flex-col sm:w-full">
